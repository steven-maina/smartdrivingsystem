			...
			<div class="row">
				<div class="col-md-7 col-lg-8 p-b-30">
					<div>
						...
						<p class="s-txt2">
							Nulla commodo iaculis ligula, ac dapibus quam ornare ut. Praesent ac hendrerit sem, et tempus sem. Donec sit amet elit a felis tristique eleifend. Aliquam erat volutpat. Cras metus ipsum, tincidunt in bibendum vitae, fringilla ac ipsum. Sed at eros quis mi pulvinar lacinia eget sed ex. Vestibulum eget ipsum porttitor, cursus urna nec, ultrices enim. Sed eget dignissim nulla, non facilisis augue. Fusce nec dictum nunc. Maecenas hendrerit tempus magna eu ultricies. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Suspendisse quis neque in eros placerat consectetur. Curabitur in sagittis elit. Aenean facilisis quam in lectus mattis, ac bibendum urna tristique. Ut a arcu venenatis, dapibus odio sit amet, convallis elit.
						</p>

						<div class="bo5-l p-l-54 p-t-15 p-b-20 m-b-28 m-t-32">
							<p class="m-txt22">
								Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur bibendum metus lectus. Ut a arcu venenatis, dapibus odio sit amet, convallis elit.
							</p>
						</div>

						<p class="s-txt2">
							Aenean vel vulputate velit, a faucibus magna. Aenean in fringilla metus. Nam feugiat aliquet convallis. Maecenas vel enim consequat nisl iaculis commodo non sit amet est. Morbi eu ligula consequat, iaculis ipsum tristiquemet, convallis elit. Praesent quam ante, luctus et erat quis, fringilla tincidunt nisi. Nunc ut aliquet erat. Maecenas placerat ante rhoncus erat feugiat fermentum. Maecenas vel tincidunt augue, et molestie est. Morbi varius ex libero, vitae mollis ex vulputate in. Donec ligula mauris, sagittis a eleifend convallis.
						</p>
					</div>
				</div>
				...
				<div class="col-md-5 col-lg-4 p-b-30">
					...
					<div class="block-5 p-t-7">
						<div class="wrap-pic-b5 wrap-pic-w bo2">
							<img src="images/team-01.jpg" alt="IMG-INSTRUCTOR">
						</div>

						<div class="wrap-text-b5 p-t-18">
							
							<span class="flex-w flex-m p-b-14">
								<span class="s-txt23 p-r-16">
									Connect via
								</span>

								<a href="#" class="fs-20 color2 hov-color-main trans-03 m-r-18">
